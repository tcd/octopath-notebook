    ...
    module FromYard
      class Attribute
        ...
        def determine_if_required()
          if Lib::Util.find_tag(self.method_code_object, "required")
        ...
        def determine_if_deprecated()
          if Lib::Util.find_tag(self.method_code_object, "deprecated")
        ...
        def determine_default_value()
          if (default = Lib::Util.find_tag(self.method_code_object, "default_value"))
            case self.ruby_type
        ...
        def find_tag(tag_name)
          return Lib::Util.find_tag(self.method_code_object, tag_name)
        end

        # @return [Array<Yard::Tags::Tag>]
        def find_tags(tag_name)
          return Lib::Util.find_tags(self.method_code_object, tag_name)
        end
